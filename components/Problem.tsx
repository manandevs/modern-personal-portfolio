    ...
    <div className="w-full bg-[#0d0d0d] rounded-t-[50px] text-white overflow-hidden">
      <main className="w-full mx-auto">
        <div className="md:py-24">
          {/* ---------- HERO SECTION ---------- */}
          <section className="py-20 sm:py-24 px-6 lg:px-8 group">
            <div className="mx-auto max-w-[1550px] flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
              <div className="max-w-[600px] w-full overflow-hidden rounded-[36px] hover:scale-[1.03] hover:shadow-xl transition-all duration-300" data-aos="fade-right">
                <img
              ...
              <div className="max-w-[1000px] text-right ml-auto" data-aos="fade-left">
                <h2 className="text-[42px] md:text-[68px] font-heading font-semibold uppercase text-white leading-[1.1]">
          ...
          <div className="mt-20 max-w-[1550px] mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {cardData.map((card, index) => (
                <div className='column group' key={index} data-aos="fade-up" data-aos-delay={index * 100}>
                  <div
          ...
          <section className="py-24 lg:py-32 max-w-[1550px] px-8 sm:px-6 mx-auto flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
            ...
            <div className="max-w-[600px] w-full overflow-hidden rounded-[36px] hover:scale-[1.03] hover:shadow-xl transition-all duration-300" data-aos="fade-left">
              <img
